      ...
      <CollapsibleSection title="Depreciation Curve" defaultOpen={false}>
        <div className="space-y-4 pt-2">
          ...
          <div className="rounded-lg bg-card p-3 shadow-sm border border-border space-y-2">
            ...
            <div className="mt-1">
              <div className="h-3 rounded-full bg-muted overflow-hidden flex">
                ...
                />
                <div
                  className="h-full bg-blue-500/40 transition-all duration-200"
          ...
          <button
            ...
            className="w-full rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700 transition-colors cursor-pointer"
          ...
          <div className="text-xs text-muted-foreground text-center space-y-0.5">
            <div>Source: {DATA_SOURCE.name}</div>
            <div>{DATA_SOURCE.note}</div>
          </div>
        </div>
      </CollapsibleSection>
    </div>
