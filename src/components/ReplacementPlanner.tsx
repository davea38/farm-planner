  ...
  if (annualCosts.length === 0 || activeMachines.length === 0) {
    return (
      <div className="flex flex-col items-center gap-2 py-8 text-muted-foreground">
        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="opacity-40"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
        <p className="text-sm font-medium">Plan when to swap each machine</p>
        <p className="text-xs text-muted-foreground/70">Set a "years until replacement" on any machine above to see your timeline and annual budget here.</p>
      </div>
    )
  }
